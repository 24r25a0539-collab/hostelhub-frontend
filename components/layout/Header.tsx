        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 top-12 w-96 bg-white dark:bg-[#1F2937] border border-[#E5E7EB] dark:border-[#374151] rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto">
              <div className="p-4 border-b border-[#E5E7EB] dark:border-[#374151] flex items-center justify-between sticky top-0 bg-white dark:bg-[#1F2937]">
              ...
              {notifications.length === 0 ? (
                ...
                <div className="divide-y divide-[#E5E7EB] dark:divide-[#374151]">
                  {notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={`p-4 cursor-pointer hover:bg-[#F5F7FA] dark:hover:bg-[#374151] transition-all flex items-start gap-3 ${
                    ...
                    >
                      ...
                      <button
                        ...
                        className="p-1 hover:bg-[#E5E7EB] dark:hover:bg-[#374151] rounded flex-shrink-0"
                      >
